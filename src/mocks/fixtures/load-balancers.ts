      ...
      endpoints: [
        {
          ...
          ports: [{ name: "http", port: 30659, protocol: "TCP" }],
        },
      ],
      ...
      endpoints: [
        {
          addressesReference: { name: "default" },
          ports: [
            { name: "http", port: 30555, protocol: "TCP" },
            { name: "grpc", port: 30341, protocol: "TCP" },
          ],
        },
      ],
      externalTrafficPolicy: "Cluster",
  ...
  },
  {
    ...
    spec: {
      endpoints: [
        {
          addressesReference: { name: "default" },
          ports: [{ name: "http", port: 31082, protocol: "TCP" }],
        },
      ],
      externalTrafficPolicy: "Cluster",
      ports: [{ name: "http", port: 80, protocol: "TCP" }],
